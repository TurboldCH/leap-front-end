...
export default function Home() {
  ...
  useEffect(() => {
    fetch(`${DOMAIN}/products/categories`, {
      method: "GET",
      headers: {
  ...
  const scrollToSection = () => {
    const section = document.getElementById(searchWord);
    if (section) {
  ...
  return (
    <div>
      <div className="flex flex-col full-height color-blue">
        ...
        <section className="relative py-20 overflow-hidden sm:pb-16 lg:pb-20 xl:pb-24">
